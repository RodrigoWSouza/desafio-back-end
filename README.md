...
Documentação: https://documenter.getpostman.com/view/15503805/TzJydbQz

## Para testar
- os dados utilizados para configuração estão em .env.example
- Para rodar testes de integração e testes unitários rodar ./vendor/bin/phpunit

## Proposta de melhoria na arquitetura
- Autenticação do usuário
- Envio de e-mails reais para os usuários
